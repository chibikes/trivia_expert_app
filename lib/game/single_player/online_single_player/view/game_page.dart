...
class _GamePageState extends State<GamePage> with TickerProviderStateMixin {
                ...
                children: [
                  ...
                  SlideTransition(
                    position: Tween<Offset>(
                        ...
                        .animate(CurvedAnimation(
                            parent: _controller!,
                            curve:
                                Interval(0.0, 1.0, curve: Curves.elasticIn))),
                    child: GestureDetector(
                      ...
                      child: CustomButton(
                        ...
                        notFailed: listBol[0],
                        child: Text(state.answers[index][0],
                  ...
                  SlideTransition(
                      ...
                      child: GestureDetector(
                        ...
                        child: CustomButton(
                          ...
                          child: Text(state.answers[index][3],
                              style: MyTextStyle.style),
                          notFailed: listBol[3],
                        ),
                      )),
                  ...
                  FadeTransition(
                    opacity: Tween(begin: 0.0, end: 1.0).animate(
                        CurvedAnimation(
                            parent: _cardController!, curve: Curves.linear)),
                    child: Card(
      ...
      if (_start == 0) {
        ...
        setState(() {
          _start % (_totalTime / 3) == 0
              ? _cardController
                  ?.forward()
                  .whenComplete(() => {_cardController?.reverse()})
              : {};
          _start--;
        });
      }
  ...
  Future<void> _playAnimation(AnimationController? colorController) async {
    try {
      ...
      /// the secret of this smooth animation is in the awaits :-). I discovered it by accident
